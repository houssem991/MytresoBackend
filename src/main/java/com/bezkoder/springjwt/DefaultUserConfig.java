    ...
    public CommandLineRunner createDefaultUser(UserRepository userRepository, RoleRepository roleRepository, AccessRepository accessRepository, AccessRoleRepository accessRoleRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            if (accessRepository.count() == 0) {
                ...
                access4.setIcon("bi bi-currency-euro");
                ...
                access5.setIcon("bi bi-arrow-down-right-circle");
                ...
                access6.setIcon("bi bi-calendar3");
                access6.setPath("/pages/gestion-echeancier-fournissseurs");
                access6.setTitle("Echeances Fournisseurs");
                access6.setExternalLink(false);
                Access access7 = new Access();
                access7.setIcon("ft-user");
                access7.setPath("/pages/gestion-clients");
                access7.setTitle("Gestion des Clients");
                access7.setExternalLink(false);
                Access access8 = new Access();
                access8.setIcon("ft-file-text");
                access8.setPath("/pages/gestion-facture-Clients");
                access8.setTitle("Documents Clients");
                access8.setExternalLink(false);
                Access access9 = new Access();
                access9.setIcon("bi bi-currency-euro");
                access9.setPath("/pages/gestion-reglements-Clients");
                access9.setTitle("Reglements Clients");
                access9.setExternalLink(false);
                Access access10 = new Access();
                access10.setIcon("bi bi-arrow-up-right-circle");
                access10.setPath("/pages/gestion-Imapyes-Clients");
                access10.setTitle("Imapyes Clients");
                access10.setExternalLink(false);
                Access access11 = new Access();
                access11.setIcon("bi bi-calendar3");
                access11.setPath("/pages/gestion-echeancier-Clients");
                access11.setTitle("Echeances Clients");
                access11.setExternalLink(false);
                Access access12 = new Access();
                access12.setIcon("fa fa-money");
                access12.setPath("/pages/Caisse");
                access12.setTitle("Caisse");
                access12.setExternalLink(false);
                Access access13 = new Access();
                access13.setIcon("bi bi-bank");
                access13.setPath("/pages/banque");
                access13.setTitle("Banque");
                access13.setExternalLink(false);
                ...
                accessRepository.save(access12);
                accessRepository.save(access13);
            }
